...
def parse_args():
    ...
    parser.add_argument('-k', '--keypoints', default='gt', type=str, metavar='NAME', help='2D gt keypoints to use')
    ...
    parser.add_argument('-l', '--log', default='log/run', type=str, metavar='PATH',
    ...
    parser.add_argument('--evaluate', default='best_epoch.bin', type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
    parser.add_argument('--render', action='store_false', help='visualize a particular video')
    parser.add_argument('--by-subject', action='store_true', help='break down error by subject (on evaluation)')
    parser.add_argument('--export-training-curves', action='store_true', help='save training curves as .png images')


    # Model arguments
    parser.add_argument('-s', '--stride', default=500, type=int, metavar='N', help='chunk size to use during training')
    parser.add_argument('-e', '--epochs', default=500, type=int, metavar='N', help='number of training epochs')
    parser.add_argument('-b', '--batch-size', default=2048, type=int, metavar='N', help='batch size in terms of predicted frames')
    ...
    parser.add_argument('-f', '--number-of-frames', default='500', type=int, metavar='N',
    ...
    # Experimental
    parser.add_argument('-gpu', default='0,1,2,3', type=str, help='assign the gpu(s) to use')
    ...
    # Visualization
    parser.add_argument('--viz-subject', type=str, metavar='STR', default='S11', help='subject to render')
    parser.add_argument('--viz-action', type=str, metavar='STR', default='WalkTogether', help='action to render')
    parser.add_argument('--viz-camera', type=int, default=0, metavar='N', help='camera to render')
    # parser.add_argument('--viz-video', type=str, metavar='PATH', default='/data/vfan/dataset/human3.6m/human3.6/videos_s11/S11/Videos/Photo.60457274.mp4', help='path to input video')
    parser.add_argument('--viz-video', type=str, metavar='PATH', default=None, help='path to input video')
    parser.add_argument('--viz-skip', type=int, default=0, metavar='N', help='skip first N frames of input video')
    parser.add_argument('--viz-output', type=str, metavar='PATH', default='S11Photo2.mp4', help='output file name (.gif or .mp4)')
    ...
    parser.add_argument('--viz-no-ground-truth', action='store_false', help='do not show ground-truth poses')
    parser.add_argument('--viz-limit', type=int, default=-1, metavar='N', help='only render first N frames')
    parser.add_argument('--viz-downsample', type=int, default=1, metavar='N', help='downsample FPS by a factor N')
    parser.add_argument('--viz-size', type=int, default=5, metavar='N', help='image size')
    parser.add_argument('--compare', action='store_false', default=True, help='Whether to compare with other methods e.g. Poseformer')
    parser.add_argument('-comchk', type=str, default='', help='checkpoint of comparison methods')
